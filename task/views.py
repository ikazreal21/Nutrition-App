...
def Index(request):
    ...
    newsresponse = requests.get(
        url=(
            'https://newsapi.org/v2/top-headlines?country=ph&category=health&apiKey={}'
            .format(APIKEY)
        )
    )
...
def Nutrients(request):
    ...
    if (
        ...
        food1 = [food1.cal, food1.protien, food1.fat, food1.vita, food1.calcium]
        food2 = Nutrient.objects.get(id=pk2)
        food2 = [food2.cal, food2.protien, food2.fat, food2.vita, food2.calcium]
        food3 = Nutrient.objects.get(id=pk3)
        food3 = [food3.cal, food3.protien, food3.fat, food3.vita, food3.calcium]
        food4 = Nutrient.objects.get(id=pk4)
        food4 = [food4.cal, food4.protien, food4.fat, food4.vita, food4.calcium]
        food5 = Nutrient.objects.get(id=pk5)
        food5 = [food5.cal, food5.protien, food5.fat, food5.vita, food5.calcium]
        food6 = Nutrient.objects.get(id=pk6)
        food6 = [food6.cal, food6.protien, food6.fat, food6.vita, food6.calcium]
        food7 = Nutrient.objects.get(id=pk7)
        food7 = [food7.cal, food7.protien, food7.fat, food7.vita, food7.calcium]
        food8 = Nutrient.objects.get(id=pk8)
        food8 = [food8.cal, food8.protien, food8.fat, food8.vita, food8.calcium]
        food9 = Nutrient.objects.get(id=pk9)
        food9 = [food9.cal, food9.protien, food9.fat, food9.vita, food9.calcium]
        food10 = Nutrient.objects.get(id=pk10)
        food10 = [food10.cal, food10.protien, food10.fat, food10.vita, food10.calcium]
        # return render(request, "task/compute.html", {"result": food})
        if (
            quantity1.isdigit()
            and quantity2.isdigit()
            and quantity3.isdigit()
            and quantity4.isdigit()
            and quantity5.isdigit()
            and quantity6.isdigit()
            and quantity7.isdigit()
            and quantity8.isdigit()
            and quantity9.isdigit()
            and quantity10.isdigit()
        ):
            ...
            context = {'cal': cal, 'pro': pro, 'fat': fat, 'vit': vit, 'calc': calc}
